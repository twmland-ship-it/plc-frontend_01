"use strict";(self["webpackChunkplc2_0"]=self["webpackChunkplc2_0"]||[]).push([[9570],{79570:function(t,e,n){n.d(e,{AC:function(){return i},J9:function(){return r},N_:function(){return l},gZ:function(){return o}});var a=n(95853);const o=a.Ay.div`
    ...
    .ant-radio-button-wrapper-disabled {
        background-color: ${({theme:t})=>t[t.mainContent]["light-text"]}30;
    }
    ...
    .ant-skeleton.ant-skeleton-active .ant-skeleton-content .ant-skeleton-title, .ant-skeleton.ant-skeleton-active .ant-skeleton-content .ant-skeleton-paragraph > li {
        background: ${({theme:t})=>t.darkMode?"linear-gradient(90deg,#323541 25%,#494B55 37%,#323541 63%)":"linear-gradient(90deg, #F1F2F6 25%, #e5e6ea 37%, #F1F2F6 63%)"};
    }
    ...
    .ant-picker {
        ...
        .ant-picker-input > input[disabled] {
            color: ${({theme:t})=>t[t.mainContent]["light-text"]}50;
        }
    }

    .ant-upload.ant-upload-select-picture-card {
        background-color: ${({theme:t})=>t[t.mainContent]["white-background"]} !important;
        border-color: ${({theme:t})=>t[t.mainContent]["border-color-deep"]} !important;
    }
    ...
    .ninjadash_upload-basic .ant-upload.ant-upload-select, .ninjadash_upload-browse {
        border-color: ${({theme:t})=>t[t.mainContent]["border-color-default"]} !important;
        background-color: ${({theme:t})=>t[t.mainContent]["light-background"]} !important;
    }
    ...
    .ninjadash-card-nav{
        ul{
            ...
            li{
                ...
                &.ninjadash-active{
                    a{
                        background-color: ${({theme:t})=>t[t.mainContent]["menu-active-bg"]};
                        color: ${({theme:t})=>t[t.mainContent]["menu-active"]};
                    }
                }
            }
    ...
    .ant-pagination-item-link {
        transform: ${({theme:t})=>t.rtl?"rotate(180deg)":"rotate(0deg)"};
    }
    ...
    .ant-form-item-control-input .ant-picker {
        padding: ${({theme:t})=>t.rtl?"0 0 0 12px":"0 12px 0 12px"} !important;
    }
    ...
    .ant-checkbox-inner{
			border-radius: 4px;
			background: ${({theme:t})=>t.darkMode?"transparent":"#fff"};
			border-color: ${({theme:t})=>t[t.mainContent]["border-color-checkbox"]};
    }
    ...
    .card-grid-wrap{
        .ant-card-grid{
            box-shadow: 1px 0 0 0 ${({theme:t})=>t[t.mainContent]["border-color-default"]}30, 0 1px 0 0 ${({theme:t})=>t[t.mainContent]["border-color-default"]}, 1px 1px 0 0 ${({theme:t})=>t[t.mainContent]["border-color-default"]}, 1px 0 0 0 ${({theme:t})=>t[t.mainContent]["border-color-default"]} inset, 0 1px 0 0 ${({theme:t})=>t[t.mainContent]["border-color-default"]} inset;
            @media only screen and (max-width: 575px){
                width: 50% !important
            }
        }
    ...
    .columnCardsWrapper .ant-card{
        // background: ${({theme:t})=>t[t.mainContent]["main-background-light-dark"]};
    }
    ...
    .ant-collapse > .ant-collapse-item.ant-collapse-item-disabled .ant-collapse-header {
        svg {
            fill: ${({theme:t})=>t["extra-light-color"]} !important;
        }
...
/* Order Summery */
    .ninjadash-order-summery{
        background-color: ${({theme:t})=>t[t.mainContent]["main-background-light"]} !important;
    }
`,i=(a.Ay.div`
    .ant-card{
        .ant-card-head{
...
`,a.Ay.div`
        ...
        .ant-table-thead{
            >tr{
                ...
                >th.ant-table-cell{
                    ...
                    font-weight: 500;
                    color: ${({theme:t})=>t[t.mainContent]["gray-light-text"]};
                    background-color: ${({theme:t})=>t[t.mainContent]["status-background"]};
                    border: 0 none;
                    &:not(:first-child){
                        text-align: ${({theme:t})=>t.rtl?"left":"right"} !important;
                    }
                    &:first-child{
    ...
    .latest-transections-table{
        ...
        .transection-single__icon {
            ...
            font-size: 20px;
            &--primary {
                background: ${({theme:t})=>t["primary-color"]}2d;
                svg{
                    fill: ${({theme:t})=>t["primary-color"]};
                }
            }
            &--info {
                background: ${({theme:t})=>t["info-color"]}2d;
                svg{
                    fill: ${({theme:t})=>t["info-color"]};
                }
            }
            &--success {
                background: ${({theme:t})=>t["success-color"]}2d;
                svg{
                    fill: ${({theme:t})=>t["success-color"]};
                }
            }
            &--warning {
                background: ${({theme:t})=>t["warning-color"]}2d;
                svg{
                    fill: ${({theme:t})=>t["warning-color"]};
                }
            }
            &--secondary {
                background: ${({theme:t})=>t["secondary-color"]}2d;
                svg{
        ...
        .transection-single__info {
            ...
            span {
                ...
                font-weight: 400;
                display: block;
                color: ${({theme:t})=>t[t.mainContent]["light-color"]};
            }
        }
        ...
        .ant-radio-group {
            color: ${({theme:t})=>t[t.mainContent]["gray-light-text"]};
						...
						.ant-radio-input:focus + .ant-radio-inner{
							box-shadow: 0 0 0 3px ${({theme:t})=>t[t.mainContent]["white-background"]};
						}
						.ant-radio-wrapper{
							span{
								color: ${({theme:t})=>t[t.mainContent]["gray-light-text"]};
...
`,a.Ay.div`
    ...
    .ant-page-header-heading-extra{
        margin: ${({theme:t})=>t.rtl?"4px auto 4px 0 !important":"4px 0 4px auto !important"};
        .action-btn {
    ...
    &.table-data-view{
        ...
        tbody{
            tr{
                &:hover{
                    td{
                        background: ${({theme:t})=>t[t.mainContent]["main-background"]};
                    }
                }
                td{
                    .product-id{
                ...
                td{
                    ...
                    .table-actions{
                        a {
                            svg, i{
                                width: 16px;
                                fill: ${({theme:t})=>t[t.mainContent]["extra-light-text"]} !important;
                            }
                            &.view{
                                &:hover{
                                  svg,
    ...
    .ant-collapse{
        ...
        > .ant-collapse-item{
            ...
            > .ant-collapse-header{
                ...
                svg{
                    fill: ${({theme:t})=>t["extra-light-color"]};
                }
            }
            .ant-collapse-extra{
                span{
    ...
    .table-search-box{
        ...
        .ant-select-selection-search{
            ...
            .ant-select-selection-search-input {
                border-radius: 20px;
                border: 0 none;
                background: ${({theme:t})=>t["bg-color-light"]} !important;
                height: 40px;
                input.ant-input{
                    background: ${({theme:t})=>t["bg-color-light"]} !important;
                    height: 40px !important;

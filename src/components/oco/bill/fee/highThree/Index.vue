  ...
  <a-form style="overflow: auto; width: 100%">
    ...
    <table class="tg">
      <tbody>
        ...
        <tr>
          <td class="tg-0lax" colspan="4">半尖峰契約</td>
          <td class="tg-0lax">
            <a-input
              v-model:value="formState.summer.contractNonSummer"
              type="number"
            />
          </td>
          <td class="tg-0lax">
        ...
        <tr>
          <td class="tg-0lax" rowspan="10">流動<br />電費</td>
          <td class="tg-0lax" rowspan="5">週一<br />至<br />週五</td>
          <td class="tg-0lax">尖峰時間</td>
          ...
          <td class="tg-0lax" rowspan="10">每度</td>
          <td class="tg-0lax">
            <a-input
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <a-input
              v-model:value="formState.summer.weekdaysHalfPeak"
              type="number"
            />
          </td>
          <td class="tg-0lax">-</td>
        ...
        <tr>
          ...
          <td class="tg-0lax">
            <div
              v-for="(v, i) in weekdayNoSummerHalfPeak"
              :key="i"
              style="margin-top: 0.5rem"
            >
              <a-time-picker v-model:value="v.StartTime" /> ~
              ...
              <span
                style="color: red; cursor: pointer"
                @click="delWeekdayNoSummerHalfPeak(i)"
              >
                刪除
              </span>
            </div>
            <div
              style="cursor: pointer; color: #1890ff; margin-top: 0.5rem"
              @click="addWeekdayNoSummerHalfPeak()"
            >
              新增時段 +
            </div>
          </td>
          ...
          <td class="tg-0lax">
            <a-input
              v-model:value="formState.noSummer.weekdaysHalfPeak"
              type="number"
            />
          </td>
        </tr>

...
const DayCalendar = defineComponent({
  ...
  setup() {
    ...
    let dateContentClickHandler = null;
    ...
    onMounted(() => {
      ...
      calenderDom.forEach((element) => {
        element.addEventListener("click", dateContentClickHandler);
        registeredElements.push(element);
      });

      if (button) {
        buttonClickHandler = () => containers.classList.add("show");
    ...
    onBeforeUnmount(() => {
      if (dateContentClickHandler) {
        registeredElements.forEach((element) => {
          element.removeEventListener("click", dateContentClickHandler);
        });
        registeredElements = [];
      }
      if (registeredButton && buttonClickHandler) {
        registeredButton.removeEventListener("click", buttonClickHandler);

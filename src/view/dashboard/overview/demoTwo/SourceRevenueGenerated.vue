    ...
    <sdCards more title="Source of Revenue Generated">
      ...
      <RevenueSourceStyle>
        ...
        <div class="chart-content__details">
          <div
            class="chart-content__single"
            v-for="({ icons, labels, revenue }, index) in dataStats"
            :key="index"
          >
            <span
            ...
            >
              ...
              <InlineSvg
                v-if="icon === 'google'"
                :src="require('@/static/img/icon/google-customIcon.svg')"
              ></InlineSvg>
            </span>
            <span v-for="(label, i) in labels" class="label" :key="i">{{
              label
            }}</span>
            <span v-for="(data, i) in revenue" class="data" :key="i"
              >${{ data }}</span
            >
          </div>
        </div>
